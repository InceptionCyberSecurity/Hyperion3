#!/usr/bin/env python3
### Original iker.py script by Portcullis Security UK.
### Modifications from original v1.1 script 2to3 Py2 to Py3 conversion by ducatinat.
####################################################################################
...
### Modified by ducatinat (nathan.jones@arcadeusops.com)
###############################################################################
